...
<asp:Content ID="Content3" ContentPlaceHolderID="contentbody" runat="server">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" class="validator" runat="server" ControlToValidate="TxtTitle" ErrorMessage="Title can be 50 chars long, and cannot contain special characters.)" ValidationExpression="^[ A-Za-z0-9]{1,50}$"></asp:RegularExpressionValidator>
        </div>
    </div>
    <div class="form-group row">
